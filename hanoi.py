"""
Test for cognitive recognition using a tower of hanoi puzzle game
----------------------

Import pygame modules appropriately - might require external download"
"""
...
def blit_text(screen, text, midtop, aa=True, font=None, font_name=None, size=None, color=(255, 0, 0)):
    ...
    :param text: text if any implemented in the app
    :type text: Any
    :param midtop: integer value used for measurements in the program
    :type midtop: Any
    :param aa: boolean parameter to use in the app
    :type aa: bool = True
    ...
    :param size: size appropriate for the app
    :type size: Any = None
    :param color: colors used in the app
...
def menu_screen():
    ...
    while not menu_done:  # every screen/scene/level has its own loop
        ...
        blit_text(screen, 'Use arrow keys to select difficulty (1-7):', (320, 150), font_name='Montserrat', size=40,
                  color=grey)
        if n_disks <= 2:
...
def game_over():
    ...
    Method to end the game after the game is terminated to show
    ...
    if steps - min_steps == 0:
        ...
        blit_text(screen, 'You did relatively well', (320, 300), font_name='Montserrat', size=35, color=green)
        blit_text(screen, 'Make sure to be careful and more observing, in order to complete in minimum steps', (320, 325),
                  font_name='Montserrat', size=26, color=green)
    elif min_steps + (min_steps * 0.20) < steps <= min_steps + (min_steps * 0.50):
        blit_text(screen, 'This is average', (320, 300), font_name='Montserrat', size=30, color=orange)
        blit_text(screen, 'You took more steps than was needed to complete the game', (320, 325),
                  font_name='Montserrat', size=24, color=orange)
    elif steps > min_steps + (min_steps * 0.50):
        blit_text(screen, 'You did quite poorly', (320, 300), font_name='Montserrat', size=30, color=red)
        blit_text(screen, 'You took several more steps on average than was needed to complete this', (320, 325),
